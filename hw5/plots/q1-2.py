...
if __name__ == "__main__":
    ...
    logs = {
        ...
        "boltzmann" : "data/hw5_expl_q1_alg_medium_boltzmann_PointmassMedium-v0_*?/events*",
    }
    ...
    plt.title(f"Learning curves for PointmassMedium-v0")
    ...
    logs = {
        ...
        "boltzmann" : "data/hw5_expl_q1_alg_hard_boltzmann_PointmassHard-v0_*?/events*",
    }
    results = get_section_results(logs)
